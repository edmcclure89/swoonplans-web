...
{
heading: '3. Swoon Type Quiz & Sharing',
body: (
<>
<p>
Your Swoon Type results are not stored on our servers. They are encoded directly into the
results link (for example, the letters after "?v=" in the URL), so the link itself is what
carries your result.
</p>
<p>
...
<p>
Anyone who opens a shared results link can see the Swoon Type and cheat sheet it contains.
Only share a results link with people you want to see it.
</p>
</>
),
},
...
enforce our agreements. You can request deletion at any time (see Section 9).
</p>
),
},
{
