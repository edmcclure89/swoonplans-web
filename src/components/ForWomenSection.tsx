...
export const ForWomenSection: React.FC<ForWomenSectionProps> = ({ onOpenInquire }) => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-8 py-12 sm:py-16">
      {/* Header Banner */}
      <div className="bg-[#1A1816] text-[#FAF8F5] rounded-sm p-8 sm:p-12 border border-[#D5C29F]/30 text-center max-w-4xl mx-auto mb-16 shadow-xl relative overflow-hidden">
        <div className="absolute -top-12 -right-12 w-48 h-48 bg-[#D5C29F]/10 rounded-full filter blur-2xl pointer-events-none" />
        
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#D5C29F]/20 text-[#D5C29F] border border-[#D5C29F]/30 rounded-full text-[10px] uppercase tracking-[0.35em] font-sans mb-4 font-bold">
          <EyeOff className="w-3.5 h-3.5 text-[#D5C29F]" />
          <span>FOR WOMEN ONLY • DISCREET NUDGE</span>
        </div>

        <h2 className="text-3xl sm:text-5xl font-serif font-light text-white italic leading-tight mb-4">
          Give Him the Cheat Code to Your Dream Date Night
        </h2>

        <p className="text-xs sm:text-sm text-white/75 font-sans max-w-2xl mx-auto font-light leading-relaxed mb-6">
        ...
        <div className="flex flex-wrap justify-center gap-4 text-xs font-sans">
          <span className="bg-white/10 px-3 py-1.5 rounded border border-white/20 text-[#D5C29F] flex items-center gap-1.5 font-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        ...
        <div className="bg-[#EFEDEB]/60 border border-[#E8E2D9] p-6 rounded space-y-3">
          ...
          <p className="text-xs text-[#6E675F] font-sans font-light leading-relaxed">
            Sit back as he answers 15 questions, receives exact venue details, and takes you out.
          </p>
        </div>
      </div>
      ...
      <div className="bg-[#1A1816] text-[#FAF8F5] rounded p-6 sm:p-10 border border-[#D5C29F]/30 max-w-3xl mx-auto space-y-6">
        <div className="text-center space-y-2">
          <Share2 className="w-6 h-6 text-[#D5C29F] mx-auto" />
        ...
        {emailSent ? (
          <div className="p-6 bg-[#D5C29F]/20 border border-[#D5C29F] text-center rounded space-y-2">
            <Sparkles className="w-6 h-6 text-[#D5C29F] mx-auto animate-bounce" />
          ...
          <form onSubmit={handleSendNudge} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] uppercase tracking-widest text-[#D5C29F] font-sans font-bold mb-1">
                  HIS EMAIL ADDRESS *
                </label>
                <input
                  type="email"
                  ...
                  className="w-full px-3 py-2.5 bg-white/10 border border-white/20 rounded text-xs text-white placeholder-white/40 focus:outline-none focus:border-[#D5C29F]"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2.5 bg-white/10 border border-white/20 rounded text-xs text-white focus:outline-none focus:border-[#D5C29F]"
              />
            </div>
