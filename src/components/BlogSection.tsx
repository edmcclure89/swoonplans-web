    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-8 py-12 sm:py-16">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
            ...
            <button
              ...
              className="px-6 py-3 bg-white/10 hover:bg-white/20 text-white font-bold text-xs uppercase tracking-[0.2em] font-sans rounded cursor-pointer transition-colors border border-white/20 text-center flex items-center justify-center gap-2"
            >
      ...
      <div className="text-center mt-12">
        <button
          ...
          className="px-8 py-3.5 bg-[#1A1816] hover:bg-[#38332E] text-[#D5C29F] font-bold text-xs uppercase tracking-[0.25em] font-sans rounded-sm cursor-pointer transition-colors"
        >
